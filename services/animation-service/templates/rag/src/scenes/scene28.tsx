...
export default makeScene2D('scene28', function* (view) {
    ...
    <Background>
      <Rect ref={cameraRef} size={['100%', '100%']} justifyContent={'center'} alignItems={'center'}>
        ...
        <Rect layout direction={'row'} gap={24} y={-10} wrap={'wrap'} width={1100} justifyContent={'center'}>
          ...
          <Card ref={app1Ref} width={310} height={160} opacity={1} glowColor={THEME.colors.primary}>
          ...
          <Card ref={app2Ref} width={310} height={160} opacity={1} glowColor={THEME.colors.cyan}>
          ...
          <Card ref={app3Ref} width={310} height={160} opacity={1} glowColor={THEME.colors.success}>
          ...
          <Card ref={app4Ref} width={310} height={160} opacity={1} glowColor={THEME.colors.purple}>
          ...
          <Card ref={app5Ref} width={310} height={160} opacity={1} glowColor={THEME.colors.warning}>
          ...
          <Card ref={app6Ref} width={310} height={160} opacity={1} glowColor={THEME.colors.error}>
  ...
  yield* all(
    ...
    chain(
      typeText(captionTxt, 'RAG powers real-world apps across customer support, legal, healthcare, finance, enterprise search, and code assistance.', 10.01)
    )
  );
});
