...
export default makeScene2D('scene25', function* (view) {
  ...
  view.add(
    <Background>
      <Rect ref={cameraRef} size={['100%', '100%']} justifyContent={'center'} alignItems={'center'}>
        ...
        {/* 1. Query */}
        <Card ref={queryCardRef} x={-750} y={0} width={160} height={110} opacity={1} alignItems={'center'} justifyContent={'center'}>
        ...
        {/* 2. Embed */}
        <Card ref={embedCardRef} x={-480} y={0} width={160} height={110} opacity={1} glowColor={THEME.colors.cyan} alignItems={'center'} justifyContent={'center'}>
        ...
        {/* 3. Vector DB */}
        <Rect ref={dbContainerRef} x={-200} y={0} opacity={1} scale={0.72}>
        ...
        {/* 4. Re-ranker */}
        <Card ref={rerankerCardRef} x={140} y={0} width={180} height={110} opacity={1} glowColor={THEME.colors.purple} alignItems={'center'} justifyContent={'center'}>
        ...
        {/* 5. Prompt */}
        <Card ref={promptCardRef} x={460} y={0} width={180} height={110} opacity={1} glowColor={THEME.colors.warning} alignItems={'center'} justifyContent={'center'}>
        ...
        {/* 6. LLM */}
        <Card ref={llmCardRef} x={760} y={0} width={160} height={110} opacity={1} glowColor={THEME.colors.success} showGlow={true} alignItems={'center'} justifyContent={'center'}>
  ...
  yield* all(
    ...
    chain(
      typeText(captionTxt, 'The full retrieval pipeline: Query → Embed → VectorDB → Re-rank → Augment Prompt → LLM Answer.', 6.82)
    )
  );
});
