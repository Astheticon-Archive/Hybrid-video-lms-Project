// Course Timeline - 60 steps of variable duration matched to voice narration
const steps = [
  {
    "id": "git-intro",
    "name": "1. Git Intro",
  ...
  },
  {
    ...
    "output": [
      "On branch main",
      "No commits yet",
      "Untracked files: index.html, styles.css, app.js"
    ],
  ...
  },
  {
    ...
    "output": [
      ...
      "Untracked files: styles.css, app.js"
    ],
  ...
  },
  {
    ...
    "output": [
      "[feature-x e4f5g6h] Add contact page",
      " 1 file changed"
    ],
  ...
  },
  {
    ...
    "output": [
      "Deleted branch feature-x (was e4f5g6h)."
    ],
  ...
  },
  {
    ...
    "command": "git stash",
    "output": [
      "Saved working directory WIP...",
      "HEAD is now at c5d6e7f"
    ],
  ...
  },
  {
    ...
    "output": [
      "stash@{0}: WIP on main: c5d6e7f Update app.js"
    ],
  ...
  },
  {
    ...
    "output": [
      "HEAD is now at e4f5g6h Add contact page"
    ],
  ...
  },
  {
    ...
    "output": [
      ...
      "c5d6e7f HEAD@{1}: commit: Update app.js"
    ],
  ...
  },
  {
    ...
    "output": [
      "HEAD is now at c5d6e7f Update app.js"
    ],
  ...
  },
  {
    ...
    "output": [
      "[main g8h9i0j] Revert \"Update app.js\"",
      " 1 file changed"
    ],
  ...
  },
  {
    ...
    "output": [
      "[main m1m2m3m] Main change in contact",
      " 1 file changed"
    ],
  ...
  },
  {
    ...
    "output": [
      "[feature-y f1f2f3f] Feature change in contact",
      " 1 file changed"
    ],
  ...
  },
  {
    ...
    "output": [
      "[main r1r2r3r] Merge branch feature-y"
    ],
  ...
  },
  {
    ...
    "output": [
      "origin  https://github.com/alice/repo.git (fetch)",
      "origin  https://github.com/alice/repo.git (push)"
    ],
...
function renderFrame(time) {
  ...
  if (!currentAudio || currentAudio.stepIdx !== stepIdx) {
    ...
    const audioDir = window.overrideAudioDir || 'assets/audio';
    currentAudio = new Audio(`${audioDir}/step_${stepIdx}.wav`);
